...
namespace UnrealFPS.Editor
{
    public class UEditor : UnityEditor.Editor
    {
        ...
        {
            GUI.color = PreferencesMenu.Data.BoxColor;
            GUILayout.BeginVertical(GUI.skin.button);
            EditorGUILayout.LabelField(message, TitleLabel);
        ...
        {
            GUILayout.Space(7);
            GUI.color = PreferencesMenu.Data.BackgroundColor;
        ...
        /// </summary>
        /// <returns></returns>
        public virtual GUIStyle TitleLabel
        {
            get
            {
